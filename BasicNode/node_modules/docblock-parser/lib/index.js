...
function docblockParser() {
  ...
  function parse(docstring) {
    if (!docstring || !config.docBlockPattern.test(docstring)) {
      throw new TypeError("Argument does not appear to be a valid docstring. A docstring " + "usually starts with /**, ends with */ and every line in between " + "starts with a single *. This is what I got instead:\n\n" + docstring);
    }
