...
describe('docblock-parser', function () {
  ...
  describe('API', function () {
    ...
    it('exposes a parse method', function () {
      expect(_typeof(docblockParser.parse)).toBe('function');
    });
  ...
  describe('Parsing', function () {
    ...
    describe('tags', function () {
      ...
      it('extracts single parameter tags', function () {
        var ds = docstring(['@foo bar', 'Some text in between', '@bar', 'baz', '@tricky', '@value']);
      ...
      it('extracts multi parameter tags', function () {
        var ds = docstring(['@foo x y z', '@bar a,', 'b,c,', 'd']);
      ...
      it('extracts multline tags', function () {
        var ds = docstring(['@foo', 'some text', 'with', '', 'empty line', '@bar some text', 'with', '', 'empty line']);
      ...
      it('groups some tags', function () {
        var ds = docstring(['@foo bar', '@foo baz']);
